...
class SQLCipherBuildExtension(build_ext):
    def build_extension(self, ext):
        #subprocess.check_call("make distclean", cwd=os.path.join(os.path.dirname(__file__), "sqlcipher"))
        subprocess.check_call("./configure", cwd=os.path.join(os.path.dirname(__file__), "sqlcipher"))
